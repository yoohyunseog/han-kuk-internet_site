...
*/
define('G5_DOMAIN', 'http://todu7.iptime.org/ITEM-INTEGER/MANAGEMENT/PROJECT-SUB/www/HANKUKINTERNET_SITE');
define('G5_HTTPS_DOMAIN', 'http://todu7.iptime.org/ITEM-INTEGER/MANAGEMENT/PROJECT-SUB/www/HANKUKINTERNET_SITE');
...
if (G5_DOMAIN) {
    ...
    if (isset($g5_path['url']))
        ...
        define('G5_URL', 'http://todu7.iptime.org/ITEM-INTEGER/MANAGEMENT/PROJECT-SUB/www/HANKUKINTERNET_SITE');
}

if (isset($g5_path['path'])) {
    define('G5_PATH', $g5_path['path']);
} else {
    define('G5_PATH', 'http://todu7.iptime.org/ITEM-INTEGER/MANAGEMENT/PROJECT-SUB/www/HANKUKINTERNET_SITE');
}
